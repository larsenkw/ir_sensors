...
class Server(object):
    def __init__(self):
        ...
        self.k_lin = 0.8 # linear velocity proportion parameter
    ...
    def velocityCommand(self):
        ...
        if (self.pose.pose.position.x == 0):
            ...
            self.msg_Twist.angular.z = self.k_ang*(np.arctan2(self.pose.pose.position.z,self.pose.pose.position.x) - np.pi/2)
